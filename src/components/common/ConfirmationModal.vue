          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              ...
              <div :class="[
                ...
                type === 'danger' ? 'bg-red-100' : type === 'warning' ? 'bg-amber-100' : 'bg-medical-blue-100'
              ]">
                <!-- Danger Icon -->
                ...
                <!-- Info Icon -->
                <svg v-else class="h-6 w-6 text-medical-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button
              ...
              :class="[
                ...
                type === 'danger' ? 'bg-red-600 hover:bg-red-500' : type === 'warning' ? 'bg-amber-600 hover:bg-amber-500' : 'bg-medical-blue-600 hover:bg-medical-blue-500'
              ]"
              @click="$emit('confirm')"
            >
              {{ confirmText }}
