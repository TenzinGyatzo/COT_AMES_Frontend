  ...
  <div class="max-w-md mx-auto mt-16">
    <div class="bg-white shadow-lg rounded-lg p-8">
      ...
      <p class="text-sm text-gray-600 mb-6 text-center">
        Ingresa para consultar cotizaciones y órdenes de trabajo
      </p>
...
// Vista de login para clientes: usa el composable useAuth que expone loginCliente
// Mantiene la consistencia arquitectónica con el resto de la aplicación

const router = useRouter();
const route = useRoute();
const { loginCliente, isLoading, error } = useAuth();
...
const handleSubmit = async () => {
  ...
  try {
    await loginCliente(email.value, password.value);
    // Si el login es exitoso, redirigir al portal cliente o a la ruta de redirect si existe
