    ...
    <div v-else-if="dashboardCounters" class="space-y-6">
      ...
      <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <!-- Cotizaciones Aceptadas (métrica principal) -->
          <div
            class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-7 border-2 border-blue-400 hover:shadow-xl transition-all transform hover:scale-105 sm:col-span-2 lg:col-span-4"
          >
